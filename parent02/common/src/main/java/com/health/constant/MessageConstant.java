...
public class MessageConstant {
    ...
    public static final String QUERY_USER_SUCCESS = "获取用户信息成功";
    public static final String QUERY_USER_FAIL = "获取用户信息失败";
    public static final String QUERY_ROLE_SUCCESS = "获取权限信息成功";
    public static final String QUERY_ROLE_FAIL = "获取权限信息失败";
    public static final String QUERY_PERMISSION_SUCCESS = "获取权限信息成功";
    public static final String QUERY_PERMISSION_FAIL = "获取权限信息失败";
    ...
    public static final String QUERY_MENU_SUCCESS = "获取页面信息成功";
    public static final String QUERY_MENU_FAIL = "获取页面信息失败";
